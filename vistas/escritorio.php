              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Ingresos y Egresos</h1>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                          <div class="small-box bg-green">
                              <div class="inner">
                                ...
                                <p>Utilidad del Mes (Eg - In)</p>                                
                              </div>
                              <div class="icon">
                                <i class="ion ion-bag"></i>
                              </div>
                              <a href="venta.php" class="small-box-footer">Utilidad <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-3">
                          <div class="small-box bg-red">
                              ...
                              <a href="gastos.php" class="small-box-footer">Gastos <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
