...
//Implementamos un método para insertar registros
	public function insertar($idcliente,$idusuario,$tipo_comprobante,$serie_comprobante,$num_comprobante,$fecha_hora,$total_venta,$idarticulo,$cantidad,$precio_venta,$impuesto)
	{	
		...
		VALUES ('$idcliente','$idusuario','Ticket','1','1','$fecha_hora','$total_venta','Aceptado')";
